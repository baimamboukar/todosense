...
const LoginForm = () => {
        ...
        try {
            ...
            const options = {
                headers: {
                    ...
                    "Login-token": localStorage.getItem("tokenx") || "",
                }
            }
            const res = await axios.post(`${HOST}/api/v1/auth/login`, data, options);
            localStorage.setItem("tokenx", res.data.authToken);
    ...
    return (
        <div className='container max-w-4xl py-4 mx-auto md:py-10'>
            <Heading title="Login" description='Login to 📝 Todosense' />
