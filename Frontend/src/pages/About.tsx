...
const messages = [
  `📝 Todosense is a cloud based Notes app build to store user's notes anytime, anywhere on the cloud with easy access to their notes.`,
...
const About = () => {
  return (
    <div className="container py-10">
      <Heading title="📝 Todosense" description="Your Notes Secured on the Cloud" className="text-center" />
