...
// ROUTE 1: Create  a User using:  POST -> "/api/v1/auth/createuser" . Note: 'No Login Required'.
router.post(
  "/createuser",
...
// ROUTE 2: Authenticate a User  using:  POST -> "/api/v1/auth/login" . Note: 'No Login Required'.
...
// ROUTE 3: Get loggedIn user details using:  POST "/api/v1/auth/getuser". Note: 'Login Required'.
